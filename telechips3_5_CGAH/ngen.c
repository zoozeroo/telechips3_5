...
void draw_game(ALLEGRO_BITMAP* background) {
    ...
    al_draw_textf(game_font, al_map_rgb(0, 0, 0), BUFFER_W - 10, 10, ALLEGRO_ALIGN_RIGHT, "LIVES: %d", game_state.lives);
    al_draw_textf(game_font, al_map_rgb(0, 0, 0), BUFFER_W / 2, 10, ALLEGRO_ALIGN_CENTER, "Stage %d/%d  Kills %d/%d", game_state.stage, MAX_STAGES, game_state.stage_kills, KILLS_TO_ADVANCE);
}
