...
bool assets_load(void) {
    ...
    icon_people1 = al_create_sub_bitmap(spr_items, P0X, P1Y, PWH, PWH); // ¿ø°Å¸®
    icon_people2 = al_create_sub_bitmap(spr_items, P0X, P2Y, PWH, PWH); // º¸Á¶
    icon_people3 = al_create_sub_bitmap(spr_items, P0X, P3Y, PWH, PWH); // ÅÊÄ¿
    ...
    icon_virus1 = al_create_sub_bitmap(spr_items, V1X, V1Y, PWH, PWH); // ÆÄ
    icon_virus2 = al_create_sub_bitmap(spr_items, V1X, V2Y, PWH, PWH); // ³ë
    icon_virus3 = al_create_sub_bitmap(spr_items, V1X, V3Y, PWH, PWH); // »¡
    icon_virus4 = al_create_sub_bitmap(spr_items, V1X, V4Y, PWH, PWH); // ÇÏ
